...
RCT_EXPORT_METHOD(loadRewardedVideoAdWithAdUnitID:(NSString *)unitId  (NSString* )customerId)
{
    
    [MPRewardedVideo loadRewardedVideoAdWithAdUnitID:unitId customerId:customerId mediationSettings:@[]];
